...
server_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)l
        ...
        if notified_socket == server_socket:
            ...
            for client_socket in clients:
                if client_socket != notified_socket:
                    client_socket.send(user["header"] + user["data"].encode("utf-8") + message["header"] + message["data"].encode("utf-8"))
